'''
Author       : ChenKt
Date         : 2021-08-30 11:16:55
LastEditors  : ChenKt
LastEditTime : 2021-08-30 17:51:38
FilePath     : /project/IO_2021/plt_MCA_MAM_JJA_lag.py
Aim          : 
Mission      : 
'''
# %%
...
def plt_mcas_BIO(s, u, v, extents):
  for i in range(N):
    ...
    import os
    savedir = '../../plot/IO_2021/MCA/JJA/MAM_BIO_MCA'+str(i+1)+'.png'
...
def plt_mcas_NIO(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/JJA/MAM_NIO_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_TIO(s, u, v, extents):
  for i in range(N):
    ...
    savedir = '../../plot/IO_2021/MCA/JJA/MAM_TIO_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO2(s, u, v, extents):
  for i in range(N):
    ...
    lineart(ax3)
    ax3.set_title('(c) ', fontdict=font, loc='left')
    savedir = '../../plot/IO_2021/MCA/JJA/MAM_SIO2_MCA'+str(i+1)+'.png'
    import os
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
...
def plt_mcas_SIO3(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/JJA/MAM_SIO3_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO1(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/JJA/MAM_SIO1_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
# %%
# note:for BIO
dir = '../../data/data/MCA/MCA_MAM_JJA_lag_BIO_pickle.dat'
...
# %%
# note:for NIO
dir = '../../data/data/MCA/MCA_MAM_JJA_lag_NIO_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
extents = [50, 110, 0, 30]
...
# %%
# note:for TIO
dir = '../../data/data/MCA/MCA_MAM_JJA_lag_TIO_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
...
dir = '../../data/data/MCA/MCA_MAM_JJA_lag_SIO1_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
extents = [50, 110, -60, 0]
...
dir = '../../data/data/MCA/MCA_MAM_JJA_lag_SIO2_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
extents = [50, 110, -30, 0]
...
dir = '../../data/data/MCA/MCA_MAM_JJA_lag_SIO3_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
extents = [50, 110, -60, -30]
