...
LastEditors  : ChenKt
LastEditTime : 2021-08-30 17:58:59
...
def plt_mcas_BIO(s, u, v, extents):
  for i in range(N):
    ...
    import os
    savedir = '../../plot/IO_2021/MCA/MAM/MAM_BIO_MCA'+str(i+1)+'.png'
...
def plt_mcas_NIO(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/MAM/MAM_NIO_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_TIO(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/MAM/MAM_TIO_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO2(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/MAM/MAM_SIO2_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO3(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/MAM/MAM_SIO3_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO1(s, u, v, extents):
  for i in range(N):
    ...
    lineart(ax3)
    ax3.set_title('(c) ', fontdict=font, loc='left')
    savedir = '../../plot/IO_2021/MCA/MAM/MAM_SIO1_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
