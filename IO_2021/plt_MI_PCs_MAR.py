'''
Author       : ChenKt
Date         : 2021-08-29 17:06:52
LastEditors  : ChenKt
LastEditTime : 2021-08-30 17:11:55
FilePath     : /project/IO_2021/plt_MI_PCs_MAR.py
Aim          :
Mission      :
'''
# %%
...
for j in range(6):
  for k in range(3):
    dir = path+'EOF/EOF_MAR_'+titles[j]+'_pickle.dat'
    with open(dir, 'rb') as f:
      eofs = pickle.load(f)
    lt = eofs[1]
    title = 'MAR '+titles[j]+' PC'+str(k+1)
    savedir = '../../plot/IO_2021/MIs/MAR/MAR_'+titles[j]+'_PC'+str(k+1)+'.png'
