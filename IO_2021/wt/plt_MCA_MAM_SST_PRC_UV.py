'''
Author       : ChenKt
Date         : 2021-08-27 15:15:31
LastEditors  : ChenKt
LastEditTime : 2021-08-28 19:31:04
FilePath     : /project/IO_2021/plt_MCA_MAM_SST_PRC_UV.py
Aim          :
Mission      :
'''
'''
...
'''
Author       : ChenKt
Date         : 2021-08-26 17:28:32
LastEditors  : ChenKt
LastEditTime : 2021-08-27 15:13:15
FilePath     : /project/IO_2021/plt_MCA_MAM_SST_PRC_UV.py
Aim          :
Mission      :
'''
...
def plt_mcas_BIO(s, u, v, extents):
  for i in range(N):
    ...
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAM/MAM_BIO_MCA'+str(i+1)+'.png', dpi=600,
...
def plt_mcas_NIO(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAM/MAM_NIO_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_TIO(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAM/MAM_TIO_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO2(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAM/MAM_SIO2_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO3(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAM/MAM_SIO3_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO1(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAM/MAM_SIO1_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
# %%
# note:for BIO
dir = '../../data/data/MCA/MCA_MAM_BIO_pickle.dat'
...
# %%
# note:for NIO
dir = '../../data/data/MCA/MCA_MAM_NIO_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
extents = [50, 110, 0, 30]
...
# %%
# note:for TIO
dir = '../../data/data/MCA/MCA_MAM_TIO_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
...
dir = '../../data/data/MCA/MCA_MAM_SIO1_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
extents = [50, 110, -60, 0]
...
dir = '../../data/data/MCA/MCA_MAM_SIO2_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
extents = [50, 110, -30, 0]
...
dir = '../../data/data/MCA/MCA_MAM_SIO3_pickle.dat'
with open(dir, 'rb') as f:
  mcas = pickle.load(f)
s, u, v = mcas[0], mcas[1], mcas[2]
extents = [50, 110, -60, -30]
