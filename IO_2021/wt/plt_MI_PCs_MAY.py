...
LastEditors  : ChenKt
LastEditTime : 2021-08-30 22:05:02
FilePath     : /project/IO_2021/wt/plt_MI_PCs_MAY.py
Aim          :
Mission      :
'''
# %%
...
# %%
dir1 = path+'wt/MIs_JJA.dat'
with open(dir1, 'rb') as f:
  MIs = pickle.load(f)
for j in range(6):
  for k in range(3):
    dir = path+'EOF/wt_EOF_MAY_'+titles[j]+'_pickle.dat'
    with open(dir, 'rb') as f:
      eofs = pickle.load(f)
    lt = eofs[1]
    title = 'MAY '+titles[j]+' PC'+str(k+1)
    savedir = '../../../plot/IO_2021/wt/MIs/MAY/MAY_' + \
