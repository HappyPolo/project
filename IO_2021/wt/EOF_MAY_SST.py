...
test_ng(lp, le, N)
# %%
with open(path+'EOF/wt_EOF_MAY_BIO_pickle.dat', 'wb') as f:
...
test_ng(lp, le, N)
# %%
with open(path+'EOF/wt_EOF_MAY_NIO_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
# note: TIO
I = 2
...
test_ng(lp, le, N)
# %%
with open(path+'EOF/wt_EOF_MAY_TIO_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
# note: SIO1
I = 3
...
test_ng(lp, le, N)
# %%
with open(path+'EOF/wt_EOF_MAY_SIO1_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
# note: SIO2
I = 4
...
test_ng(lp, le, N)
# %%
with open(path+'EOF/wt_EOF_MAY_SIO2_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
# note: SIO3
I = 5
...
test_ng(lp, le, N)
# %%
with open(path+'EOF/wt_EOF_MAY_SIO3_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
