...
LastEditors  : ChenKt
LastEditTime : 2021-08-30 22:11:05
FilePath     : /project/IO_2021/wt/EOF_MAM_SST_lt.py
Aim          : 
Mission      : 
'''
# %%
...
test_ng(lp, le, N)
# %%
with open(path+'wt/EOF/EOF_MAM_BIO_pickle.dat', 'wb') as f:
...
test_ng(lp, le, N)
# %%
with open(path+'wt/EOF/EOF_MAM_NIO_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
# note: TIO
I = 2
...
test_ng(lp, le, N)
# %%
with open(path+'wt/EOF/EOF_MAM_TIO_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
# note: SIO1
I = 3
...
test_ng(lp, le, N)
# %%
with open(path+'wt/EOF/EOF_MAM_SIO1_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
# note: SIO2
I = 4
...
test_ng(lp, le, N)
# %%
with open(path+'wt/EOF/EOF_MAM_SIO2_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
# note: SIO3
I = 5
...
test_ng(lp, le, N)
# %%
with open(path+'wt/EOF/EOF_MAM_SIO3_pickle.dat', 'wb') as f:
  pkl = pickle.dump([lp, le, frac], f, protocol=-1)
# %%
