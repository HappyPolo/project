...
LastEditors  : ChenKt
LastEditTime : 2021-08-28 19:36:30
...
def plt_mcas_BIO(s, u, v, extents):
  for i in range(N):
    ...
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAY/MAY_BIO_MCA'+str(i+1)+'.png', dpi=600,
...
def plt_mcas_NIO(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAY/MAY_NIO_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_TIO(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAY/MAY_TIO_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO2(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAY/MAY_SIO2_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO3(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAY/MAY_SIO3_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO1(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    plt.show
    fig.savefig('../../plot/IO_2021/MCA/MAY/MAY_SIO1_MCA'+str(i+1)+'.png', dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
