'''
Author       : ChenKt
Date         : 2021-08-30 10:26:19
LastEditors  : ChenKt
LastEditTime : 2021-08-30 11:06:49
FilePath     : /project/IO_2021/MCA_MAM_SST_JJA_PRC_UV.py
Aim          : 
Mission      : 
'''
# %%
...
U = selYear(UWD, 1982, 2020)
V = selYear(VWD, 1982, 2020)
# %%
# note : MAM
sst_MAM = standardize(detrend_dim(
    lsmask(month_to_season(SST, 'MAM'), path+fls), 'time'))
prc_MAM = standardize(detrend_dim(month_to_season(PRC, 'JJA'), 'time'))
u_MAM = standardize(detrend_dim(month_to_season(U, 'JJA'), 'time'))
v_MAM = standardize(detrend_dim(month_to_season(V, 'JJA'), 'time'))
sst_MAM['time'] = prc_MAM['time']
# %%
# note : BIO
I = 0
...
with open(path+'MCA/MCA_MAM_JJA_lag_BIO_pickle.dat', 'wb') as f:
...
v_out = [vle, vre, vlt, vrt, Fracv, rphetv, Corrv]
svd_out = [s_out, u_out, v_out]
with open(path+'MCA/MCA_MAM_JJA_lag_NIO_pickle.dat', 'wb') as f:
  pkl = pickle.dump([s_out, u_out, v_out], f, protocol=-1)
...
v_out = [vle, vre, vlt, vrt, Fracv, rphetv, Corrv]
svd_out = [s_out, u_out, v_out]
with open(path+'MCA/MCA_MAM_JJA_lag_TIO_pickle.dat', 'wb') as f:
  pkl = pickle.dump([s_out, u_out, v_out], f, protocol=-1)
...
v_out = [vle, vre, vlt, vrt, Fracv, rphetv, Corrv]
svd_out = [s_out, u_out, v_out]
with open(path+'MCA/MCA_MAM_JJA_lag_SIO1_pickle.dat', 'wb') as f:
  pkl = pickle.dump([s_out, u_out, v_out], f, protocol=-1)
...
v_out = [vle, vre, vlt, vrt, Fracv, rphetv, Corrv]
svd_out = [s_out, u_out, v_out]
with open(path+'MCA/MCA_MAM_JJA_lag_SIO2_pickle.dat', 'wb') as f:
  pkl = pickle.dump([s_out, u_out, v_out], f, protocol=-1)
...
v_out = [vle, vre, vlt, vrt, Fracv, rphetv, Corrv]
svd_out = [s_out, u_out, v_out]
with open(path+'MCA/MCA_MAM_JJA_lag_SIO3_pickle.dat', 'wb') as f:
  pkl = pickle.dump([s_out, u_out, v_out], f, protocol=-1)
