...
LastEditors  : ChenKt
LastEditTime : 2021-08-31 12:49:18
FilePath     : /project/IO_2021/plt_MI_PCs_MAY.py
Aim          :
Mission      :
'''
# %%
...
for j in range(6):
  for k in range(3):
    dir = path+'EOF/EOF_MAY_'+titles[j]+'_pickle.dat'
    with open(dir, 'rb') as f:
      eofs = pickle.load(f)
    lt = eofs[1]
    title = 'MAY '+titles[j]+' PC'+str(k+1)
    savedir = '../../plot/IO_2021/MIs/MAY/MAY_'+titles[j]+'_PC'+str(k+1)+'.png'
