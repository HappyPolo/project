...
LastEditors  : ChenKt
LastEditTime : 2021-08-30 17:47:37
...
def plt_mcas_BIO(s, u, v, extents):
  for i in range(N):
    ...
    savedir = '../../plot/IO_2021/MCA/APR/APR_BIO_MCA'+str(i+1)+'.png'
...
def plt_mcas_NIO(s, u, v, extents):
  for i in range(N):
    ...
    ax3.plot(x, s[3][i], ls='-', c='r', label='prc')
    lineart(ax3)
    savedir = '../../plot/IO_2021/MCA/APR/APR_NIO_MCA'+str(i+1)+'.png'
    ax3.set_title('(c) ', fontdict=font, loc='left')
...
def plt_mcas_TIO(s, u, v, extents):
  for i in range(N):
    ...
    lineart(ax3)
    ax3.set_title('(c) ', fontdict=font, loc='left')
    savedir = '../../plot/IO_2021/MCA/APR/APR_TIO_MCA'+str(i+1)+'.png'
    import os
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
...
def plt_mcas_SIO2(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/APR/APR_SIO2_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO3(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/APR/APR_SIO3_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
...
def plt_mcas_SIO1(s, u, v, extents):
  for i in range(N):
    ...
    ax3.set_title('(c) ', fontdict=font, loc='left')
    import os
    savedir = '../../plot/IO_2021/MCA/APR/APR_SIO1_MCA'+str(i+1)+'.png'
    if os.path.isfile(savedir):
      os.remove(savedir)
    fig.savefig(savedir, dpi=600,
                bbox_inches='tight', pad_inches=0.0, facecolor='w', format='png')  # %%
